...
//    }
    ...
    public boolean onBackPressed() {
        if (!fullScreenOnly && PlayerManager.this.getScreenOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
    ...
    private int getScreenOrientation() {
        return ScreenUtil.INSTANCE.getScreenOrientation(mActivity.getWindowManager());
    }
